...
/*void click(BITMAP **buffer)
{
if(mouse_b & 1 && makecol(20,150,250))
{
//circlefill(screen,200,390,10,makecol(0,0,0));
circlefill(screen,30,300,10,makecol(20,150,250));
p=0;
}
}*/
void click2()
...
rest(10);
clear_bitmap(buffer);
//thick_line(screen,m,n,r,s,7,makecol(255,0,0));
//putpixel(screen,x1+i,y1-j,164);
//if((m&&n)==(p&&q))
//circlefill(screen,p+50,q-50,10,makecol(132,123,0));
